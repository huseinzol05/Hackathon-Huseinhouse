...
#py_socket = SocketIO('http://www.huseinhouse.com:9002/sensorcamera', 9002, LoggingNamespace)
...
class Camera(BaseCamera):
    ...
    def frames():
        ...
        while True:
            ...
            hot_windows = search_windows(img, windows, clf, X_scaler, xy_window, color_space=color_space, 
                        spatial_size=spatial_size, hist_bins=hist_bins, 
                        orient=orient, pix_per_cell=pix_per_cell, 
                        cell_per_block=cell_per_block)
